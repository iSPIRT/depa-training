...
CONFIG_PATH = "mnt/config/medqa_config.json"
...
# Example usage:
DATASET_NAME = config.get("DATASET_NAME", "Malikeh1375/medical-question-answering-datasets")
DATASET_SPLIT = config.get("DATASET_SPLIT", "all-processed")
SAVE_DIR = config.get("SAVE_DIR", '/mnt/output/medqa/')
