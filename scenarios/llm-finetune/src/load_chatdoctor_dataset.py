...
CONFIG_PATH = "mnt/config/chatdoctor_config.json"
...
# Example usage:
DATASET_NAME = config.get("DATASET_NAME", "lavita/ChatDoctor-HealthCareMagic-100k")
SAVE_DIR = config.get("SAVE_DIR", '/mnt/output/chatdoctor/')
