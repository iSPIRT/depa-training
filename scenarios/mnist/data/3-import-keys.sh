...
DATADIR=`pwd`
import_key "MNIST_1_FilesystemEncryptionKey" $DATADIR/mnist_1key.bin
import_key "MNIST_2_FilesystemEncryptionKey" $DATADIR/mnist_2key.bin
import_key "MNIST_3_FilesystemEncryptionKey" $DATADIR/mnist_3key.bin
