...
dp_mnist_3_output_folder='/mnt/output/mnist_3/'

# DP Standardisation Non Anon Files
dp_mnist_3_std_nonanon_file ='dp_mnist_3_standardised_nonanon.csv'

# DP Standardisation  Anon | Tokenised Files
dp_mnist_3_std_anon_file ='dp_mnist_3_standardised_anon.csv'
...
def dp_process_mnist_3_full(input_folder,data_file,load=True,debug=True):
    """
    Standardisation of mnist_3 data done at Data Provider Infrastructure
    ...
    sandbox_dp_mnist_3=data_loaded
    if debug:
      sandbox_dp_mnist_3.show()
    ...
    # Create the Output
    sandbox_dp_mnist_3.toPandas().to_csv(dp_mnist_3_output_folder+ dp_mnist_3_std_nonanon_file)


    sandbox_dp_mnist_3.toPandas().to_csv(dp_mnist_3_output_folder + dp_mnist_3_std_anon_file)
    
    if debug_poc:
      print("Debug | Dataset Created ", "sandbox_mnist_3_processed_anon")
      print("Debug | sandbox_mnist_3_nonanon count =", sandbox_dp_mnist_3.count())
      print("Debug | sandbox_mnist_3_anon count =", sandbox_dp_mnist_3.count())
      sandbox_dp_mnist_3.show()
      sandbox_dp_mnist_3.show()

    return sandbox_dp_mnist_3


ccr_sandbox_mnist_3=dp_process_mnist_3_full(model_input_folder,mnist_3_file,True,True)
