...
if [[ "$AZURE_KEYVAULT_ENDPOINT" == *".vault.azure.net" ]]; then 
    ...
    NAME_AVAILABLE=$(az rest --method post \
	  --uri 'https://management.azure.com/subscriptions/a8eb34c2-6598-49ca-8838-8456fb01374d/providers/Microsoft.KeyVault/checkNameAvailability?api-version=2019-09-01' \
